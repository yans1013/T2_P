...
//        navigationItem.rightBarButtonItem = addButton
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(reloadTableView), name: NSNotification.Name(rawValue: "reloadTextViewNotification"), object: nil)
    }
    
    @objc func reloadTableView(notification: Notification){
        let relist = notification.object as! NSMutableArray
        self.listData = relist
...
//            context.delete(fetchedResultsController.object(at: indexPath))
            ...
            let note = self.listData[indexPath.row] as! Note
            self.listData = self.bl.remove(model: note)
